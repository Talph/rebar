...
<div class="container">
    <div class="animated fadeIn">
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Create blog post </h1>
        ...
        <form action="{{route('posts.store')}}" enctype="multipart/form-data" method="POST">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 col-lg-3 col-xl-3">
                    ...
                    {{-- <div class="card mt-4 card-collapsable">
                <a class="card-header" href="#collapseCardDate" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardDate">
                    {{ __('Date') }}
                    </a>
