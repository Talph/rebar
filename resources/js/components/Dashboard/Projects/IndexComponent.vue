      ...
      <div class="row shadow my-2">
        <div class="col-md-6">
          ...
          <div class="createProduct border-2 my-4">
            <a class="btn btn-primary" href=/dashboard/projects/create>Create New Project</a>
          </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="card-body">
              <table id="dataTable" class="table table-striped table-bordered" style="width: 100%;">
                ...
                <tr class="odd" v-for="(project, index) in projects" :key="index">
                  <td>{{ project.title }}</td>
                  <td>
                                        <span v-for="(author, index) in project.author" :key="index">
                                            {{ author.name }}
                                        </span>
                  </td>
                  <td>{{ project.metaDesc }}</td>
                  <td>{{ project.projectedAt }}</td>
                  <td>
                                      <span class="draft">
                                          {{ project.isPublished }}
                                      </span>
                  ...
                  <td>
                    <div class="dropdown no-arrow">
                      <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLinkProjects"
                      ...
                      <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                        ...
                        <a :href="'/dashboard/projects/edit/' + project.id " class="btn dropdown-item">Edit</a>
                        <div class="dropdown-divider"></div>
                        <form @submit.prevent="deleteProject(project.id)">
